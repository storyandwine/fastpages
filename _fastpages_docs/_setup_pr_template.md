Hello :wave: @storyandwine!  Thank you for using fastpages!  
...
- GitHub Actions will build your site, which will take 2-3 minutes to complete.  **This will happen anytime you push changes to the master branch of your repository.**  You can monitor the logs of this if you like on the [Actions tab of your repo](https://github.com/storyandwine/fastpages/actions).
- Your GH-Pages Status badge on your README will eventually appear and be green, indicating your first successful build.
- You can monitor the status of your site in the GitHub Pages section of your [repository settings](https://github.com/storyandwine/fastpages/settings).

If you are not using a custom domain, your website will appear at: 

#### https://storyandwine.github.io/fastpages
